...
namespace Anviz\MqttClient\Client\Repositories;
...
use Anviz\MqttClient\Client\PublishedMessage;
use Anviz\MqttClient\Client\TopicSubscription;
use Anviz\MqttClient\Client\UnsubscribeRequest;
